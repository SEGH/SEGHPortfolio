    ...
    return (
        <Jumbotron id="portfolio" className="bg-light shadow-lg rounded mt-5 p-4">
            ...
            <Row>
                ...
                <PortfolioCard image={searchBooks} alt={"Book Search"} title={"Book Search"} description={"Search for books and save to a list"} deployedLink={"https://book-srch.herokuapp.com/"} repoLink={"https://github.com/SEGH/bookSearch"} tools={["mongodb", "express", "react", "node", "materialize", "GoogleBooks API"]} />
                <PortfolioCard image={plasma} alt={"Lyric Dash"} title={"Lyric Dash"} description={"Make playlists of your favorite songs and quickly access the lyrics"} deployedLink={"https://lyric-dash.herokuapp.com/"} repoLink={"https://github.com/SEGH/lyricDash"} tools={["mySql", "express", "sequelize", "node", "handlebars", "jquery", "Bulma CSS"]} />
