...
export default function Portfolio() {
    return (
        <Jumbotron id="portfolio" className="bg-light shadow-lg rounded mt-5 p-4">
            ...
            <hr className="my-4" />
            <Row>
                <PortfolioCard image={returnSafe} alt={"Return Safe"} title={"Return Safe"} description={"Allows schools and businesses to track users' locations and symptoms for contact tracing"} deployedLink={"https://return-safe.herokuapp.com/"} repoLink={"https://github.com/SEGH/Return-Safe"} tools={["mongodb", "express", "react", "node", "javaScript", "html", "css", "materialize", "React-Calender", "Google-Maps-React"]} />
                <PortfolioCard image={searchBooks} alt={"Book Search"} title={"Book Search"} description={"Search for books and save to a list"} deployedLink={"https://googlebooks-80891.herokuapp.com/"} repoLink={"https://github.com/SEGH/bookSearch"} tools={["mongodb", "express", "react", "node", "javaScript", "html", "css", "materialize", "GoogleBooks API"]} />
                <PortfolioCard image={plasma} alt={"PLASMA project"} title={"PLASMA Dashboard"} description={"Make playlists of your favorite songs and quickly access the lyrics"} deployedLink={"https://plasma-playlistdashboard.herokuapp.com/"} repoLink={"https://github.com/SEGH/PLASMA"} tools={["mySql", "express", "sequelize", "node", "handlebars", "javaScript", "jquery", "html", "css", "Bulma CSS"]} />
                <PortfolioCard image={burger} alt={"BurgerApp project"} title={"Burger App"} description={"Enter burger orders and note when they are completed"} deployedLink={"https://enthousiaste-choucroute-00740.herokuapp.com/"} repoLink={"https://github.com/SEGH/burger"} tools={["mySql", "express", "node", "handlebars", "javaScript", "jquery", "html", "css", "bootstrap"]} />
                ...
                <PortfolioCard image={bookNook} alt={"Book Nook"} title={"Book Nook"} description={"Get book suggestions based on your favorite movies"} deployedLink={"https://segh.github.io/Book-Nook/"} repoLink={"https://github.com/SEGH/Book-Nook"} tools={["javaScript", "jquery", "html", "css", "Foundation CSS", "OMDB API", "iTunes API", "Bing API"]} />
            </Row>
